...
import icon1 from "../assets/Images/Ellipse 7.png";
import icon2 from "../assets/Images/Ellipse 15.png";

function Testimonial() {
  return (
    <div className="bg-gray-100 py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto text-center">
      <h2 className="font-semibold btn bg-gradient-to-r inline-block text-transparent bg-clip-textbg-gradient-to-r from-[#9384Ef] to-[#312EFE] bg-clip-text px-8 py-3 rounded-t-lg justify-center rounded-md">
          Client Reviews
        </h2>
            ...
            <div className="p-6 bg-white">
              <div className="mt-6">
                ...
                <blockquote className="text-gray-500">
                  ...
                  <hr class="h-px my-8 bg-gray-400  00 border-0 dark:bg-gray-700"></hr>
                </blockquote>
